...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).json;
                return [4 /*yield*/, new users_1["default"]().get()];
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                data = req.validated;
                data.password = bcrypt_1["default"].hashSync(data.password + (0, dontenv_1.env)("bcybt_password"), parseInt((0, dontenv_1.env)("salt")));
                _b = (_a = res).json;
...
exports["default"] = (function (App) {
    App.get("/users", index);
    App.post("/users", [(0, validatorMw_1["default"])(rules_1["default"])], store);
});
