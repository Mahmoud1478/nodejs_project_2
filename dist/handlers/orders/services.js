...
var index = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = response).json;
                return [4 /*yield*/, new user_1.default().select(["id", "firstname", "lastname"]).get()];
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _b = (_a = response).json;
                return [4 /*yield*/, new user_1.default().create(data)];
            case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
        }
    });
}); };
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                console.log(data);
                _b = (_a = response).json;
                return [4 /*yield*/, new user_1.default().where("id", request.params.id).update(data)];
            case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
        }
    });
}); };
...
var destroy = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = response).json;
                return [4 /*yield*/, new user_1.default().where("id", request.params.id).delete()];
            case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
        }
    });
}); };
...
var sign_in = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = request.validated;
                return [4 /*yield*/, new user_1.default().find("firstname", data.firstname)];
            case 1:
                user = _a.sent();
